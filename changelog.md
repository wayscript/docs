...
* We optimized the performance of WayScript’s [File System](getting_started/file-system.md) by limiting unnecessary rendering and squashing a few persistent bugs.
* We continued to make performance improvements to Wayscript’s [Code Editor](getting_started/code-editors.md), including how the editor handles [Variable](getting_started/variables.md) pills and new key bindings for our `vim` fans out there.
...
* ![](.gitbook/assets/trello%20%281%29%20%282%29%20%282%29%20%282%29%20%281%29.png) When using our[ Trello Trigger](library/triggers/trello-trigger.md), the Change\_List and Changed\_Card structs now output the correct values.
...
* The following modules and triggers have had their outputs transformed into [Structs](getting_started/variables.md#structs), to better align with the rest of the system:
  ...
  * ![](.gitbook/assets/scryfall%20%282%29%20%283%29%20%283%29%20%283%29%20%282%29.png) [Scryfall](library/modules/scryfall.md)
  * ![](.gitbook/assets/spotify%20%282%29%20%281%29.png) [Spotify](library/modules/spotify.md)
  * ![](.gitbook/assets/trello%20%281%29%20%282%29%20%282%29%20%282%29%20%281%29.png) [Trello](library/modules/trello.md)
  ...
  * ![](.gitbook/assets/trello%20%281%29%20%282%29%20%282%29%20%282%29%20%281%29.png) [Trello Trigger](library/triggers/trello-trigger.md)
...
* ![](.gitbook/assets/http%20%282%29%20%283%29%20%283%29%20%283%29%20%281%29.png) We have added [additional metadata](library/triggers/http-trigger.md#http-metadata) to the HTTP Trigger.
...
* ![](.gitbook/assets/http%20%282%29%20%283%29%20%283%29%20%283%29.png) The [HTTP Response](library/modules/http-response.md) module now allows returning XML content, with a text/xml MIME type.
